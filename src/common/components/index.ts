// index.ts
// 可复用 UI 组件导出
export { FileInput } from '@/common/components/FileInput';
export { FolderInput } from '@/common/components/FolderInput';
export { FileNameInput } from '@/common/components/FileNameInput';
...
// 组件类型定义导出
export type { FileInputOptions } from '@/common/components/FileInput';
export type { FolderInputOptions } from '@/common/components/FolderInput';
export type { FileNameInputOptions } from '@/common/components/FileNameInput';
